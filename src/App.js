...
const Component = ({
  ...
  const onResizeEnd = async (e) => {
    ...
    //TODO identificar cuando 
    console.log(height, "anterior heei")
    console.log(newHeight, "anterior heei")
    console.log(ref.current.style.top, "anterior top")
    ...
    console.log(lastEvent.drag.top)
    updateMoveable(
      id,
      {
      //   top: top + beforeTranslate[1] < 0 ? 0 : absoluteTop,
      // left: left + beforeTranslate[0] < 0 ? 0 : absoluteLeft,
        // top: absoluteTop,
        // left: absoluteLeft,
        top,
        left,
  ...
  return (
    <>
      ...
      <Moveable
        ...
        draggable
        onDrag={(e) => {
          console.log(e.top, "e.top al mover el div")
          updateMoveable(id, {
            top: e.top,
            left: e.left,
            width,
